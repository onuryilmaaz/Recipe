      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          <Input
            ...
            placaholder={type == "new" ? "Message" : "Add a reply"}
            type="text"
          />
          <div className="flex items-center justify-end gap-4">
            <button
              className="flex items-center gap-1.5 text-[14px] font-medium text-gray-500 bg-gray-100 px-2 py-0.5 rounded-full hover:bg-gray-800 hover:text-white cursor-pointer"
              disabled={loading}
